				...
				<div class="flex-1 flex xl:overflow-hidden">
					...
					>
						...
						<div class="flex-1 min-h-0 overflow-y-auto">
							...
							<a
								href="#"
								class="bg-blue-50 bg-opacity-50 flex p-6 border-b border-slate-200"
								aria-current="page"
							>
								<!-- Heroicon name: outline/cog -->
								<svg
									class="flex-shrink-0 -mt-0.5 h-6 w-6 text-slate-400"
									xmlns="http://www.w3.org/2000/svg"
									fill="none"
									viewBox="0 0 24 24"
									stroke-width="2"
							...
							<a
								href="#"
								class="hover:bg-blue-50 hover:bg-opacity-50 flex p-6 border-b border-slate-200"
							>
							...
							>
								...
								<div class="ml-3 text-sm">
									...
									<p class="mt-1 text-slate-500">
										Orci aliquam arcu egestas turpis cursus. Lectus faucibus netus dui auctor
										mauris.
									</p>
								</div>
							</a>
							...
							>
								...
								<div class="ml-3 text-sm">
									...
									<p class="mt-1 text-slate-500">
										Nisi, elit volutpat odio urna quis arcu faucibus dui. Mauris adipiscing
										pellentesque.
									</p>
								</div>
							</a>
							...
							>
								...
								<div class="ml-3 text-sm">
									...
									<p class="mt-1 text-slate-500">
										Quis viverra netus donec ut auctor fringilla facilisis. Nunc sit donec cursus
										sit quis et.
									</p>
								</div>
							</a>
							...
							<form class="mt-6 space-y-8 divide-y divide-y-slate-200">
								<div class="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
									...
									<div class="sm:col-span-3">
										<label for="first-name" class="block text-sm font-medium text-slate-900">
											First name
										</label>
										<input
											type="text"
											...
											class="mt-1 block w-full border-slate-300 rounded-md shadow-sm text-slate-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500"
										/>
									</div>

									<div class="sm:col-span-3">
										<label for="last-name" class="block text-sm font-medium text-slate-900">
											Last name
										</label>
										<input
											type="text"
									...
									<div class="sm:col-span-6">
										<label for="username" class="block text-sm font-medium text-slate-900">
											Username
										</label>
										<div class="mt-1 flex rounded-md shadow-sm">
											<span
												class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-slate-300 bg-slate-50 text-slate-500 sm:text-sm"
											>
												workcation.com/
											</span>
											<input
												...
												value="lisamarie"
												class="flex-1 block w-full min-w-0 border-slate-300 rounded-none rounded-r-md text-slate-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500"
											/>
										</div>
									</div>
									...
									<div class="sm:col-span-6">
										...
										<div class="mt-1 flex items-center">
											...
											<div class="ml-4 flex">
												<div
													class="relative bg-white py-2 px-3 border border-slate-300 rounded-md shadow-sm flex items-center cursor-pointer hover:bg-slate-50 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-slate-50 focus-within:ring-blue-500"
												>
													<label
														for="user-photo"
														class="relative text-sm font-medium text-slate-900 pointer-events-none"
													>
														<span>Change</span>
												...
												<button
													type="button"
													class="ml-3 bg-transparent py-2 px-3 border border-transparent rounded-md text-sm font-medium text-slate-900 hover:text-slate-700 focus:outline-none focus:border-slate-300 focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-50 focus:ring-blue-500"
													>Remove</button
												>
											</div>
										</div>
									...
									<div class="sm:col-span-6">
										...
										<div class="mt-1">
											<textarea
												...
												name="description"
												rows="4"
												class="block w-full border border-slate-300 rounded-md shadow-sm sm:text-sm focus:ring-blue-500 focus:border-blue-500"
											/>
										</div>
								...
								<div class="pt-8 grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
									...
									<div class="sm:col-span-3">
										<label for="phone-number" class="block text-sm font-medium text-slate-900">
											Phone number
										</label>
										<input
											type="text"
									...
									<div class="sm:col-span-3">
										<label for="country" class="block text-sm font-medium text-slate-900">
											Country
										</label>
										<select
											id="country"
									...
									<div class="sm:col-span-3">
										<label for="language" class="block text-sm font-medium text-slate-900">
											Language
										</label>
										<input
											type="text"
								...
								<div class="pt-8 flex justify-end">
									<button
										type="button"
										class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-slate-900 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
										>Cancel</button
									>
									<button
										type="submit"
